# Eccentric GWTC-1
We construct eccentricity posteriors for GWTC-1 events using `SEOBNRE` ([Zhoujian Cao and Wen-Biao Han, 2017](https://journals.aps.org/prd/abstract/10.1103/PhysRevD.96.044028)) waveforms with aligned spin and eccentricity.
